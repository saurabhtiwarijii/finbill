/// FinBill — Sale line item card widget.
///
...
///   - Remove button
///
/// File location: lib/features/sales/widgets/sale_line_item_row.dart
library;
...
class SaleLineItemRow extends StatefulWidget {
  ...
  @override
  State<SaleLineItemRow> createState() => _SaleLineItemRowState();
}

class _SaleLineItemRowState extends State<SaleLineItemRow> {
  ...
  // Track whether we're programmatically updating to avoid re-triggering onChanged
  ...
  @override
  void didUpdateWidget(covariant SaleLineItemRow oldWidget) {
    super.didUpdateWidget(oldWidget);
    // Sync name when populated from inventory (via picker or autocomplete)
  ...
  /// Filters inventory items based on query (case-insensitive partial match).
  ...
  /// Builds the item name field with real-time autocomplete dropdown.
